                 ...
                 tabPanel(icon("home"), 
                          fluidPage(
                            ...
                            p(strong("Access by clicking on each row of each dataset in"),actionLink("link_to_tabpanel_TopSTRSTR",strong("TopSTR",style = "color:#337ab7")), ".",
                              style = "font-size: 13pt"),
                            p(actionLink("link_to_tabpanel_Accessible_STR",strong("5. Accessible_STR",style = "color:#337ab7")),style = "font-size: 14pt"),
                            p("Genome-wide accessible STR variation in ", em("P. falciparum "),  "genome basd on ",
                              ...
                              style= "font-size: 13pt"),
                            p(style="text-align: justify;","These STRs show highly accurate calls (No Mendelian errors or discordance between biological replicates) in three experimental genetic crosses of ", em("P. falciparum "), "(98 samples).",style = "font-size: 13pt"),
                            br(),
                            br(),
                            br(),
                            br(),
...
server <- function(input, output,session) {
  ...
  Pf = good_pf %>% 
    dplyr::select(STRLocus,Motif,copies,Gene,Product.Description,Category,Heterozygosity) %>% 
  ...
  str_Rshiny = str_R %>% 
    rename("# Repeatcopies (Pf3D7)" = "Repeatcopies")
